        ...
        for current_in_channel in prange(in_channels):
            for current_kh in range(kh):
                for current_kw in range(kw):
                    if (
                        reverse
                        and 0 <= (current_height - current_kh)
                        and 0 <= (current_width - current_kw)
                    ):
                        input_val = input[
                            current_batch * s10
                            + current_in_channel * s11
                            + (current_height - current_kh) * s12
                            + (current_width - current_kw) * s13
                        ]
                    elif (
                        not reverse
                        and (current_height + current_kh) < height
                        and (current_width + current_kw) < width
                    ):
                        input_val = input[
                            current_batch * s10
                            + current_in_channel * s11
